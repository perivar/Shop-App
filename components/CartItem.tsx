...
import { removeFromCart } from '../redux/methods/products';
...
const CartItem: React.FC<CartItemProps> = props => {
  ...
  const numberOfProduct = useAppSelector(state => state.allProducts.counter);
  const findProduct = numberOfProduct.find(
    product => product.product === props.id
  );
  return (
      ...
      <View style={styles.itemContainer}>
        <View style={styles.top}>
          ...
          <View style={styles.middle}>
            ...
            <View style={styles.middlecontent}>
              ...
              <View>
                <Text style={styles.counter}>{findProduct.number}</Text>
              </View>
              <Text style={styles.totalPrice}>{props.price}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.bottom}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.productText}>SEE PRODUCT</Text>
            <Ionicons
              style={styles.trashIcon}
